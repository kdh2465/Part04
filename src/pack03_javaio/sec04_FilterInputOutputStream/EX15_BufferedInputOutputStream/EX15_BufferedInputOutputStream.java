...
public class EX15_BufferedInputOutputStream {
	public static void main(String[] args) throws IOException {
		//#파일 생성
		File orgfile = new File("sec04.files/mycat_origin.jpg");
		File copyfile1 = new File("sec04.files/mycat_copy1.jpg");
		File copyfile2 = new File("sec04.files/mycat_copy2.jpg");
